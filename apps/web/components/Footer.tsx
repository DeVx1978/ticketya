...
export function Footer() {
  ...
  return (
    <footer className="border-t border-black/5 bg-brand-dark px-4 py-10">
      ...
      <div className="mx-auto mt-8 max-w-5xl border-t border-white/10 pt-6 text-center text-xs text-white/40">
