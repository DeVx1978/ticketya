...
**AUTORIZACION EXPLICITA DEL DIRECTOR (11-ago-2026): confirmado construir los items 32 y 33 -- son pequenos, ya documentados, extienden el sistema de WhatsApp existente, no requieren ninguna decision de negocio adicional. Unica condicion: investigar primero el detalle tecnico real de como funciona hoy el sistema de notificaciones (que evento dispara cada mensaje, con que anticipacion) antes de construir el aviso nuevo, para seguir el mismo patron real, no uno inventado aparte.**
